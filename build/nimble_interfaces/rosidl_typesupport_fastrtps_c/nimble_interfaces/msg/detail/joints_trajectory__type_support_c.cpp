...
#include "nimble_interfaces/msg/detail/joints_trajectory__rosidl_typesupport_fastrtps_c.h"
...
#include "std_msgs/msg/detail/float32_multi_array__functions.h"  // phase
...
using _JointsTrajectory__ros_msg_type = nimble_interfaces__msg__JointsTrajectory;

static bool _JointsTrajectory__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _JointsTrajectory__ros_msg_type * ros_message = static_cast<const _JointsTrajectory__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
...
static bool _JointsTrajectory__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _JointsTrajectory__ros_msg_type * ros_message = static_cast<_JointsTrajectory__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_nimble_interfaces__msg__JointsTrajectory(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _JointsTrajectory__ros_msg_type * ros_message = static_cast<const _JointsTrajectory__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_std_msgs__msg__Float32MultiArray(
    &(ros_message->phase), current_alignment);
  // field.name trajectory
...
static uint32_t _JointsTrajectory__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_nimble_interfaces__msg__JointsTrajectory(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nimble_interfaces
size_t max_serialized_size_nimble_interfaces__msg__JointsTrajectory(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _JointsTrajectory__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_nimble_interfaces__msg__JointsTrajectory(
...
static message_type_support_callbacks_t __callbacks_JointsTrajectory = {
  "nimble_interfaces::msg",
  "JointsTrajectory",
  _JointsTrajectory__cdr_serialize,
  _JointsTrajectory__cdr_deserialize,
  _JointsTrajectory__get_serialized_size,
  _JointsTrajectory__max_serialized_size
};

static rosidl_message_type_support_t _JointsTrajectory__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_JointsTrajectory,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nimble_interfaces, msg, JointsTrajectory)() {
  return &_JointsTrajectory__type_support;
}
