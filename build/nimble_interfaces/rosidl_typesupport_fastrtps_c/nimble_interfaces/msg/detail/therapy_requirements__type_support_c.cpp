...
#include "nimble_interfaces/msg/detail/therapy_requirements__rosidl_typesupport_fastrtps_c.h"
...
using _TherapyRequirements__ros_msg_type = nimble_interfaces__msg__TherapyRequirements;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TherapyRequirements__ros_msg_type * ros_message = static_cast<const _TherapyRequirements__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: min_assist_level
  {
    cdr << ros_message->min_assist_level;
  }

  // Field name: max_assist_level
  {
  ...
  void * untyped_ros_message)
{
  ...
  _TherapyRequirements__ros_msg_type * ros_message = static_cast<_TherapyRequirements__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _TherapyRequirements__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_nimble_interfaces__msg__TherapyRequirements(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nimble_interfaces__msg__TherapyRequirements;
    is_plain =
      (
...
static size_t _TherapyRequirements__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_nimble_interfaces__msg__TherapyRequirements(
...
static message_type_support_callbacks_t __callbacks_TherapyRequirements = {
...
static rosidl_message_type_support_t _TherapyRequirements__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TherapyRequirements,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nimble_interfaces, msg, TherapyRequirements)() {
  return &_TherapyRequirements__type_support;
}
