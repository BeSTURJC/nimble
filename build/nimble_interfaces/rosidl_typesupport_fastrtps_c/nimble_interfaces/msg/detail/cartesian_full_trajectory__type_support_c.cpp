...
#include "nimble_interfaces/msg/detail/cartesian_full_trajectory__rosidl_typesupport_fastrtps_c.h"
...
using _CartesianFullTrajectory__ros_msg_type = nimble_interfaces__msg__CartesianFullTrajectory;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _CartesianFullTrajectory__ros_msg_type * ros_message = static_cast<const _CartesianFullTrajectory__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _CartesianFullTrajectory__ros_msg_type * ros_message = static_cast<_CartesianFullTrajectory__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _CartesianFullTrajectory__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_nimble_interfaces__msg__CartesianFullTrajectory(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nimble_interfaces__msg__CartesianFullTrajectory;
    is_plain =
      (
...
static size_t _CartesianFullTrajectory__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_nimble_interfaces__msg__CartesianFullTrajectory(
...
static message_type_support_callbacks_t __callbacks_CartesianFullTrajectory = {
...
static rosidl_message_type_support_t _CartesianFullTrajectory__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_CartesianFullTrajectory,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nimble_interfaces, msg, CartesianFullTrajectory)() {
  return &_CartesianFullTrajectory__type_support;
}
