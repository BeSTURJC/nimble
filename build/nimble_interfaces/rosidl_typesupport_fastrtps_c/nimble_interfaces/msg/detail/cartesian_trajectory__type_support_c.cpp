...
#include "nimble_interfaces/msg/detail/cartesian_trajectory__rosidl_typesupport_fastrtps_c.h"
...
using _CartesianTrajectory__ros_msg_type = nimble_interfaces__msg__CartesianTrajectory;
...
static uint32_t _CartesianTrajectory__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_nimble_interfaces__msg__CartesianTrajectory(
...
static size_t _CartesianTrajectory__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_nimble_interfaces__msg__CartesianTrajectory(
