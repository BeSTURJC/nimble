...
{
  new (message_memory) nimble_interfaces::msg::CartesianTrajectory(_init);
}

void CartesianTrajectory_fini_function(void * message_memory)
{
  auto typed_message = static_cast<nimble_interfaces::msg::CartesianTrajectory *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CartesianTrajectory_message_member_array[3] = {
  {
    ...
    offsetof(nimble_interfaces::msg::CartesianTrajectory, header),  // bytes offset in struct
...
{
  return &::nimble_interfaces::msg::rosidl_typesupport_introspection_cpp::CartesianTrajectory_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nimble_interfaces, msg, CartesianTrajectory)() {
  return &::nimble_interfaces::msg::rosidl_typesupport_introspection_cpp::CartesianTrajectory_message_type_support_handle;
}
