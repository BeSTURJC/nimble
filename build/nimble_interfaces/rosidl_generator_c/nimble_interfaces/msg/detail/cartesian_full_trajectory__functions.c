...
nimble_interfaces__msg__CartesianFullTrajectory__init(nimble_interfaces__msg__CartesianFullTrajectory * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    nimble_interfaces__msg__CartesianFullTrajectory__fini(msg);
    return false;
  }
  // left_pelvis
...
nimble_interfaces__msg__CartesianFullTrajectory__create()
{
  ...
  nimble_interfaces__msg__CartesianFullTrajectory * msg = (nimble_interfaces__msg__CartesianFullTrajectory *)allocator.allocate(sizeof(nimble_interfaces__msg__CartesianFullTrajectory), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(nimble_interfaces__msg__CartesianFullTrajectory));
  bool success = nimble_interfaces__msg__CartesianFullTrajectory__init(msg);
  if (!success) {
...
nimble_interfaces__msg__CartesianFullTrajectory__Sequence__init(nimble_interfaces__msg__CartesianFullTrajectory__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nimble_interfaces__msg__CartesianFullTrajectory * data = NULL;

  if (size) {
    data = (nimble_interfaces__msg__CartesianFullTrajectory *)allocator.zero_allocate(size, sizeof(nimble_interfaces__msg__CartesianFullTrajectory), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = nimble_interfaces__msg__CartesianFullTrajectory__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        nimble_interfaces__msg__CartesianFullTrajectory__fini(&data[i - 1]);
      }
...
nimble_interfaces__msg__CartesianFullTrajectory__Sequence__fini(nimble_interfaces__msg__CartesianFullTrajectory__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      nimble_interfaces__msg__CartesianFullTrajectory__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nimble_interfaces__msg__CartesianFullTrajectory__Sequence * array = (nimble_interfaces__msg__CartesianFullTrajectory__Sequence *)allocator.allocate(sizeof(nimble_interfaces__msg__CartesianFullTrajectory__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = nimble_interfaces__msg__CartesianFullTrajectory__Sequence__init(array, size);
  if (!success) {
...
nimble_interfaces__msg__CartesianFullTrajectory__Sequence__destroy(nimble_interfaces__msg__CartesianFullTrajectory__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    nimble_interfaces__msg__CartesianFullTrajectory__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
nimble_interfaces__msg__CartesianFullTrajectory__Sequence__are_equal(const nimble_interfaces__msg__CartesianFullTrajectory__Sequence * lhs, const nimble_interfaces__msg__CartesianFullTrajectory__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!nimble_interfaces__msg__CartesianFullTrajectory__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  nimble_interfaces__msg__CartesianFullTrajectory__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(nimble_interfaces__msg__CartesianFullTrajectory);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    nimble_interfaces__msg__CartesianFullTrajectory * data =
      (nimble_interfaces__msg__CartesianFullTrajectory *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nimble_interfaces__msg__CartesianFullTrajectory__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nimble_interfaces__msg__CartesianFullTrajectory__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!nimble_interfaces__msg__CartesianFullTrajectory__copy(
