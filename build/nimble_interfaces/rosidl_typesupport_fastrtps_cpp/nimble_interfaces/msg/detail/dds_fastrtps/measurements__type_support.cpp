...
#include "nimble_interfaces/msg/detail/measurements__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const nimble_interfaces::msg::Measurements & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  nimble_interfaces::msg::Measurements & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nimble_interfaces::msg::Measurements;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const nimble_interfaces::msg::Measurements *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<nimble_interfaces::msg::Measurements *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Measurements__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const nimble_interfaces::msg::Measurements *>(
...
static size_t _Measurements__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Measurements(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Measurements__callbacks = {
...
static rosidl_message_type_support_t _Measurements__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Measurements__callbacks,
...
{
  return &nimble_interfaces::msg::typesupport_fastrtps_cpp::_Measurements__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nimble_interfaces, msg, Measurements)() {
  return &nimble_interfaces::msg::typesupport_fastrtps_cpp::_Measurements__handle;
}
