...
#include "nimble_interfaces/msg/detail/cartesian_full_trajectory__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nimble_interfaces::msg::CartesianFullTrajectory;
    is_plain =
      (
...
static bool _CartesianFullTrajectory__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  auto typed_message =
    static_cast<const nimble_interfaces::msg::CartesianFullTrajectory *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}

static bool _CartesianFullTrajectory__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  auto typed_message =
    static_cast<nimble_interfaces::msg::CartesianFullTrajectory *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CartesianFullTrajectory__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const nimble_interfaces::msg::CartesianFullTrajectory *>(
...
static size_t _CartesianFullTrajectory__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_CartesianFullTrajectory(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CartesianFullTrajectory__callbacks = {
  "nimble_interfaces::msg",
  "CartesianFullTrajectory",
  _CartesianFullTrajectory__cdr_serialize,
  _CartesianFullTrajectory__cdr_deserialize,
  _CartesianFullTrajectory__get_serialized_size,
  _CartesianFullTrajectory__max_serialized_size
};

static rosidl_message_type_support_t _CartesianFullTrajectory__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CartesianFullTrajectory__callbacks,
...
{
  return &nimble_interfaces::msg::typesupport_fastrtps_cpp::_CartesianFullTrajectory__handle;
}
