...
bool nimble_interfaces__msg__cartesian_trajectory__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nimble_interfaces.msg._cartesian_trajectory.CartesianTrajectory", full_classname_dest, 63) == 0);
  }
  nimble_interfaces__msg__CartesianTrajectory * ros_message = _ros_message;
  {  // header
...
PyObject * nimble_interfaces__msg__cartesian_trajectory__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("nimble_interfaces.msg._cartesian_trajectory");
