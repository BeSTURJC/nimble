...
static const _JointsTrajectory_type_support_symbol_names_t _JointsTrajectory_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nimble_interfaces, msg, JointsTrajectory)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nimble_interfaces, msg, JointsTrajectory)),
  }
};
...
{
  return &::nimble_interfaces::msg::rosidl_typesupport_cpp::JointsTrajectory_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, nimble_interfaces, msg, JointsTrajectory)() {
  return get_message_type_support_handle<nimble_interfaces::msg::JointsTrajectory>();
}
