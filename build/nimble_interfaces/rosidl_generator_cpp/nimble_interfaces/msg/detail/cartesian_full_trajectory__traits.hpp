...
#ifndef NIMBLE_INTERFACES__MSG__DETAIL__CARTESIAN_FULL_TRAJECTORY__TRAITS_HPP_
#define NIMBLE_INTERFACES__MSG__DETAIL__CARTESIAN_FULL_TRAJECTORY__TRAITS_HPP_
...
inline void to_flow_style_yaml(
  const CartesianFullTrajectory & msg,
  std::ostream & out)
{
  out << "{";
  // member: header
...
inline std::string to_yaml(const CartesianFullTrajectory & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const nimble_interfaces::msg::CartesianFullTrajectory & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const nimble_interfaces::msg::CartesianFullTrajectory & msg)
{
  return nimble_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<nimble_interfaces::msg::CartesianFullTrajectory>()
{
  return "nimble_interfaces::msg::CartesianFullTrajectory";
}

template<>
inline const char * name<nimble_interfaces::msg::CartesianFullTrajectory>()
{
  return "nimble_interfaces/msg/CartesianFullTrajectory";
}

template<>
struct has_fixed_size<nimble_interfaces::msg::CartesianFullTrajectory>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<nimble_interfaces::msg::CartesianFullTrajectory>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<nimble_interfaces::msg::CartesianFullTrajectory>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // NIMBLE_INTERFACES__MSG__DETAIL__CARTESIAN_FULL_TRAJECTORY__TRAITS_HPP_
