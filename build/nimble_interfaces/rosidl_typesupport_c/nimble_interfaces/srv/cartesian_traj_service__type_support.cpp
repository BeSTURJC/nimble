...
static const _CartesianTrajService_Request_type_support_symbol_names_t _CartesianTrajService_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nimble_interfaces, srv, CartesianTrajService_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nimble_interfaces, srv, CartesianTrajService_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, nimble_interfaces, srv, CartesianTrajService_Request)() {
  return &::nimble_interfaces::srv::rosidl_typesupport_c::CartesianTrajService_Request_message_type_support_handle;
}
...
static const _CartesianTrajService_Response_type_support_symbol_names_t _CartesianTrajService_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nimble_interfaces, srv, CartesianTrajService_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nimble_interfaces, srv, CartesianTrajService_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, nimble_interfaces, srv, CartesianTrajService_Response)() {
  return &::nimble_interfaces::srv::rosidl_typesupport_c::CartesianTrajService_Response_message_type_support_handle;
}
...
static const _CartesianTrajService_type_support_symbol_names_t _CartesianTrajService_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nimble_interfaces, srv, CartesianTrajService)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nimble_interfaces, srv, CartesianTrajService)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, nimble_interfaces, srv, CartesianTrajService)() {
  return &::nimble_interfaces::srv::rosidl_typesupport_c::CartesianTrajService_service_type_support_handle;
}
