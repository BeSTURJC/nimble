...
static const _FrameData_type_support_symbol_names_t _FrameData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, frame_data, msg, FrameData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, frame_data, msg, FrameData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, frame_data, msg, FrameData)() {
  return &::frame_data::msg::rosidl_typesupport_c::FrameData_message_type_support_handle;
}
